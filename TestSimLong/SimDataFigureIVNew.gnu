...
Models = 'LPS LS LP PS LPSLow LSLow'
		...
		do for [model = 1:words(Models)] {
			...
			if (model == words(Models)) & (parameter%2){
				...
				if(tissue == words(Tissues)){
					set xtics ( '\footnotesize{LPS}' 1, '\footnotesize LS' 2, '\footnotesize LP' 3, '\footnotesize PS' 4, '\footnotesize LPS$_{\\\textrm{low b}}$' 5, '\footnotesize LS$_{\\\textrm{low b}}$' 6) rotate by -30 offset -1,0 out
				} 
