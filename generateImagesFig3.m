folder = 'C:\Users\213452\Documents\GitHub\md-dmri\GE\data\processed\2018-11-22_Premier_corrected_waveforms\set1';
...
params = {'MD','FA','uFA','MKa','MKi'};
limits = [3.5 1 1 1.5 1.25];

% Load WM mask
mks = load('WMMask WMMask.mat');
